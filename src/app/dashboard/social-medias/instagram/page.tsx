...
export default function App() {
  return (
    <div className='flex flex-col gap-4 mx-4 justify-center items-center'>
      <div className='flex justify-center items-center sm:flex-row gap-6'>
        <div>
          <Line options={options} data={data} />
          <div>
            <div className='flex justify-between items-center mx-12 gap-4 shadow-lg p-4 rounded-xl'>
      ...
      <Link
        ...
        className='bg-gray-400 text-white p-4 rounded-3xl '>
